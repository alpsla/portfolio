...
export const PROJECTS: IProject[] = [
  ...
  },
  {
    ...
    attachments: [
      ...
      { kind: 'doc', title: 'WCTV Config Comparison Report', src: '/assets/config-comparison/spreadsheets/WCTV-ConfigValidation-ProdVsRc-20252310.xlsx', sensitivity: 'internal' },
    ],
    links: [
