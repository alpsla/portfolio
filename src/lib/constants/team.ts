...
export const TEAM_MEMBERS: TeamMember[] = [
  ...
  },
  {
    ...
    keySkills: ['Test Automation', 'GenAI Tools', 'Cross-Platform Testing', 'CI/CD Integration', 'Data Quality Analysis', 'Mentoring & Leading Team'],
    professionalInterests: ['Innovation Driven Delivery', 'Generative AI', 'DevOps', 'Cloud'],
    hobbies: ['Tech Trends', 'Playing Tennis', 'Watching Sports'],
  },
  {
    id: 'rob1nalex',
    name: 'Robin Alex',
  ...
  },
  {
    ...
    keySkills: ['Test Automation', 'Device Testing', 'OTT Testing', 'Manual Testing', 'GenAI Tools', 'Cross-Platform Testing', 'Data Quality Analysis', 'Agile Methodologies', 'Defect Management'],
    professionalInterests:  ['Test data management', 'AI-powered testing', 'Test Automation Strategy', 'Cross-Platform QA', 'Generative AI', 'Agile Quality Leadership'],
    hobbies: ['Music', 'Reading', 'Traveling', 'Movies', 'Health & Fitness'],
  },
];
