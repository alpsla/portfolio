 ...
 * Author: AR
 * Created: 2025-11-05
 * Description: Hero section for personal portfolios with introduction and social links
 */
            ...
            <div className="flex items-center justify-center gap-4 flex-wrap">
              {social.linkedin && (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg"
                >
              ...
              {social.github && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-gray-800 hover:bg-gray-900 text-white rounded-lg font-semibold transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {config.personal?.showResume && (
                <a
                  href={config.personal.resumePath || '/resume.pdf'}
                  download
                  className="inline-flex items-center gap-2 px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-semibold transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg"
                >
